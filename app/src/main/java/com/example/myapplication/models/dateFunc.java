...
public class dateFunc extends BaseObject {

      public Date a ;


public dateFunc(){super();}

public dateFunc(Date a){
this.a=a;

}

      private static final String METHOD_NAME = "dateFunc";
    ...
    switch (index)
      {
            ...
            case 0 :
               if(value.toString().equalsIgnoreCase("anyType{}"))
                    a = new SimpleDateFormat("dd / MM / yyyy").parse("01 / 01 / 1900");
               else
                    a = DateUtil.getDate(value.toString());
