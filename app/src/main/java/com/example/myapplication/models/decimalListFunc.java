...
public class decimalListFunc extends BaseObject {

      public ArrayOfDecimal param ;


public decimalListFunc(){super();}

public decimalListFunc(ArrayOfDecimal param){
this.param=param;

}

      private static final String METHOD_NAME = "decimalListFunc";
