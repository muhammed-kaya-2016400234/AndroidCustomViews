...
public class ArrayOfDecimal extends Vector<BigDecimal> implements KvmSerializable {

private static final long serialVersionUID = 1L;

public ArrayOfDecimal(){super();}
public ArrayOfDecimal(BigDecimal[] a){
...
public ArrayOfDecimal(List<BigDecimal> list){
...
protected String getItemDescriptor() {return "decimal"; }
...
public void loadSoapObject(Object obj){
		if(obj == null) return;
        ArrayOfDecimal property = (ArrayOfDecimal) obj;
